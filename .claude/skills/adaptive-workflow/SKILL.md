...
- **F2 Environment:** `.ai/env_check.ps1` (PowerShell, puro-aware — falls back to the
  ...
  surfaces `plans/UNFINISHED.md` at Stop.
...
ROADMAP `- [ ]` scan, UNFINISHED-in-Stop) are candidates to fold back into
workflow-core rather than carried locally forever — see
[`.claude/workflow-core/CONTRIBUTING.md`](../../workflow-core/CONTRIBUTING.md) and
GUIDE §10 for the classification + PR process.
