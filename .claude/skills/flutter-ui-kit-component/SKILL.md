...
- [`Documentations/design-system-contract.md`](../../Documentations/design-system-contract.md) — the full contract (layer rules, naming, token-only rule, default-with-override, testing, versioning).
